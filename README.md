...
data_list = [
   '不错，盖子严实，质量好' ，
    '质量很不错的一套保温碗～～颜值也高～～材质也好～～很喜欢～～',
    '第一次用，居然轻轻就能有划痕。。。100多的碗就这质量？？',
    '外观真心喜欢很萌，价格也是很贵的，到是质量不值这个钱，看到评论有说碗内全是划痕，我不信呀买了，结果，天呀失望，果然316L材质碗内全是划痕，我真的很小心的力道，因为是米糊能下多重手，全是痕呀'
]
 pl_neg,pl_pos = sen(data_list)
print('差评为:')
print(pl_neg)
print('------------------------------')
print('好评为:')
...
差评为:
                                                  评价            系数  情感
2                      第一次用，居然轻轻就能有划痕。。。100多的碗就这质量？？  4.334399e-04  负向

3  外观真心喜欢很萌，价格也是很贵的，到是质量不值这个钱，看到评论有说碗内全是划痕，我不信呀买了...  9.604788e-07  负向

好评为:
                               评价        系数  情感
0                     不错，盖子严实，质量好  0.998518  正向
1  质量很不错的一套保温碗～～颜值也高～～材质也好～～很喜欢～～  1.000000  正向
...
data_list = [
   '不错，盖子严实，质量好',
    '质量很不错的一套保温碗～～颜值也高～～材质也好～～很喜欢～～',
    '第一次用，居然轻轻就能有划痕。。。100多的碗就这质量？？',
    '外观真心喜欢很萌，价格也是很贵的，到是质量不值这个钱，看到评论有说碗内全是划痕，我不信呀买了，结果，天呀失望，果然316L材质碗内全是划痕，我真的很小心的力道，因为是米糊能下多重手，全是痕呀&hellip;&hellip;钢材能这样不结实？图片就不附上了'
]
pl_neg,pl_pos = sen(data_list)
aa = [sentiment_mine(i) for i in data_list]
print(aa)
~~~
...
aa = discover_feature(data_list,'盖子','质量','颜值')
print(aa)
~~~
